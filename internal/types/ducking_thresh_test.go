...
func TestDuckingSettingsRowThresh(t *testing.T) {
	...
	if int(DuckingSettingsRowDepth) != 2 {
		t.Errorf("DuckingSettingsRowDepth should be 2, got %d", DuckingSettingsRowDepth)
	}
	if int(DuckingSettingsRowAttack) != 3 {
		t.Errorf("DuckingSettingsRowAttack should be 3, got %d", DuckingSettingsRowAttack)
	}
	if int(DuckingSettingsRowRelease) != 4 {
		t.Errorf("DuckingSettingsRowRelease should be 4, got %d", DuckingSettingsRowRelease)
	}
	if int(DuckingSettingsRowThresh) != 5 {
		t.Errorf("DuckingSettingsRowThresh should be 5, got %d", DuckingSettingsRowThresh)
	}
